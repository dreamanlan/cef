...
#include "myapp/cefclient/browser/main_message_loop_multithreaded_win.h"
...
#include "myapp/shared/browser/main_message_loop_external_pump.h"
#include "myapp/shared/browser/main_message_loop_std.h"
#include "myapp/shared/browser/util_win.h"
...
int RunMain(HINSTANCE hInstance,
  ...
  bool is_debug = (exeLastDirName == "webagentdbg");
...
#else
  // Use the default icon from webagent.exe.
