...
#include "myapp/cefclient/browser/client_types.h"

#if defined(OS_WIN)
#include "myapp/cefclient/browser/temp_window_win.h"
#elif defined(OS_LINUX)
#include "myapp/cefclient/browser/temp_window_x11.h"
#elif defined(OS_MAC)
#include "myapp/cefclient/browser/temp_window_mac.h"
#endif
