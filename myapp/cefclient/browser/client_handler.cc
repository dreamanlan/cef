...
#include "myapp/cefclient/browser/client_handler.h"
...
#include "myapp/shared/common/binary_value_utils.h"
...
bool ClientHandler::OnDragEnter(CefRefPtr<CefBrowser> browser,
  ...
  if ((mask & DRAG_OPERATION_LINK) && !dragData->IsFragment()) {
    test_runner::Alert(browser, "webagent blocks dragging of URLs and files");
    return true;
  }
...
bool ClientHandler::GetAuthCredentials(CefRefPtr<CefBrowser> browser,
  ...
  // Shared with DefaultClientHandler so managed and unmanaged windows behave
